                            ...
                            Contexts const & contexts_ )
{
       ...
       Dictionary::WebMultimediaDownload::isAudioUrl( url ) )
  {
    ...
    {
      QMessageBox::critical( this, "Nomad Dictionary", tr( "Missing dictionary file." ) );
      return;
    }
    else
      ...
      if ( (*i)->dataSize() >= 0 )
      {
             ...
             Dictionary::WebMultimediaDownload::isAudioUrl( resourceDownloadUrl ) )
        {
...
#endif
          {
            ...
            {
              QMessageBox::critical( this, "Nomad Dictionary", tr( "Failed to run a player to play sound file: %1" ).arg( e.what() ) );
            }
          }
        }
        else
        {
...

          {
            ...
            {
              QMessageBox::critical( this, "Nomad Dictionary", tr( "Failed to create temporary file." ) );
              return;
            }
